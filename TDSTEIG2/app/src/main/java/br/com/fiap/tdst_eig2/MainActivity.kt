...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val itensSpinner = arrayOf<String>("Selecione", "Residencial", "Comercial", "Celular", "Outros")
        ...
        btnMsg.setOnClickListener{
            if (campoValido()){
                var msg = """Nome: ${txtNome.text}
                    ...
                    |Tipo do Telefone: ${spinnerTipoTelefone.selectedItem}
                    |Email: ${txtEmail.text}
